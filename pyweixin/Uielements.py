...
class ListItem_Control():
    def __init__(self,language=language,Version=Version):
        ...
        if self.language=='简体中文':
            ...
            self.ContactsListItem={'control_type':'ListItem','title_re':r'联系人.*\d+','class_name':'mmui::ContactsCellGroupView'}#主界面切换至通讯录后，通讯录列表内的联系人项目（4.1.9.x 兼容：联系人123 / 联系人(123) / 联系人 123）
